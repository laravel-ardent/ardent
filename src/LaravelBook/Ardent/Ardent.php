...
abstract class Ardent extends Model {
    ...
    /**
     * By default, Adrent will assist you in updating fields with "unique" validation
     * Set this to false if you'd like to manage this yourself.
     * @var bool
     */
    public $autoUniqueUpdates = true;
